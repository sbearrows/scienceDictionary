...
A searchable dictionary ADT using a hash table as the underlying structure. This type of ADT can be useful when collaborating with other laboratries to prevent non-descriptive or duplicated variable names during the scientific process.
